...
(
	...
	SEATS				INT				NOT NULL,
	ID_TABLETYPE		INT				NOT NULL FOREIGN KEY(ID_TABLETYPE) REFERENCES TABLETYPE(ID_TABLETYPE),
...
(
	...
	ID_RESERVATIONSTATUS INT			NOT NULL FOREIGN KEY(ID_RESERVATIONSTATUS) REFERENCES RESERVATIONSTATUS(ID_RESERVATIONSTATUS),
	ID_CUSTOMER			INT				NULL FOREIGN KEY(ID_CUSTOMER) REFERENCES CUSTOMER(ID_CUSTOMER),
	ID_TABLE			INT				NOT NULL FOREIGN KEY(ID_TABLE) REFERENCES [TABLE](ID_TABLE),
...
(
	...
	ID_DISHCATEGORY		INT				NOT NULL FOREIGN KEY(ID_DISHCATEGORY) REFERENCES DISHCATEGORY(ID_DISHCATEGORY),
	PRIMARY KEY(ID_DISH)
);
...
(
	...
	ID_INVENTORYITEMTYPE INT			NOT NULL FOREIGN KEY(ID_INVENTORYITEMTYPE) REFERENCES INVENTORYITEMTYPE(ID_INVENTORYITEMTYPE),
...
(
	ID_DISH				INT				NOT NULL FOREIGN KEY(ID_DISH) REFERENCES DISH(ID_DISH),
	ID_INVENTORYITEM	INT				NOT NULL FOREIGN KEY(ID_INVENTORYITEM) REFERENCES INVENTORYITEM(ID_INVENTORYITEM),
	AMOUNT				FLOAT			NOT NULL,
...
(
	ID_RESERVATION		INT				NOT NULL FOREIGN KEY(ID_RESERVATION) REFERENCES RESERVATION(ID_RESERVATION),
	ID_DISH				INT				NOT NULL FOREIGN KEY(ID_DISH) REFERENCES DISH(ID_DISH),
...
(
	...
	NOTE				NVARCHAR(150)	NULL,
	ID_ORDERSTATUS		INT				NOT NULL FOREIGN KEY(ID_ORDERSTATUS) REFERENCES ORDERSTATUS(ID_ORDERSTATUS),
	ID_CART				INT				NOT NULL FOREIGN KEY(ID_CART) REFERENCES CART(ID_CART),
	ID_PAYMENT			INT				NOT NULL FOREIGN KEY(ID_PAYMENT) REFERENCES PAYMENT(ID_PAYMENT),
...
(
	...
	ISASSIGNED			BIT				NOT NULL DEFAULT 0,		-- is the shift assigned to the staff?
	ATTENDED			BIT				NULL,					-- is the staff attended the shift?
	ISLATE				BIT				NULL,		
...
(
	ID_STAFF			INT				NOT NULL FOREIGN KEY(ID_STAFF) REFERENCES STAFF(ID_STAFF),
	ID_PAYROLL			INT				NOT NULL FOREIGN KEY(ID_PAYROLL) REFERENCES PAYROLL(ID_PAYROLL),
	DAYS				TINYINT			NOT NULL,
	HOURS				FLOAT			NOT NULL,
	ABSENCETIMES		TINYINT			NOT NULL,
	LATETIMES			TINYINT			NOT NULL,
...
(
	ID_INVENTORYITEM	INT				NOT NULL FOREIGN KEY(ID_INVENTORYITEM) REFERENCES INVENTORYITEM(ID_INVENTORYITEM),
	ID_IMPORTTICKET		INT				NOT NULL FOREIGN KEY(ID_IMPORTTICKET) REFERENCES IMPORTTICKET(ID_IMPORTTICKET),
	AMOUNT				FLOAT			NOT NULL,
	SUBTOTAL			FLOAT			NOT NULL,
