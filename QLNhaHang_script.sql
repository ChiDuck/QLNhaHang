...
(
	...
	ID_DISH				INT				NULL,
	ID_INVENTORYITEM	INT				NULL,
	AMOUNT				FLOAT			NOT NULL,
	FOREIGN KEY(ID_DISH) REFERENCES DISH(ID_DISH),
	FOREIGN KEY(ID_INVENTORYITEM) REFERENCES INVENTORYITEM(ID_INVENTORYITEM)
);
...
(
	ID					INT				IDENTITY(1,1) PRIMARY KEY,
	ID_SHIPORDER		INT				NULL,
	ID_DISH				INT				NULL,
	QUANTITY			INT				NOT NULL,
	SUBTOTAL			FLOAT			NOT NULL,
	FOREIGN KEY(ID_SHIPORDER) REFERENCES SHIPORDER(ID_SHIPORDER),
	FOREIGN KEY(ID_DISH) REFERENCES DISH(ID_DISH)
);
